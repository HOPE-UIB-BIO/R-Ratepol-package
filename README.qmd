...
[![Codecov-test-coverage](https://codecov.io/gh//HOPE-UIB-BIO/R-Ratepol-package/branch/main/graph/badge.svg)](https://app.codecov.io/gh//HOPE-UIB-BIO/R-Ratepol-package?branch=main)
...
doi: [![DOI badge](https://img.shields.io/badge/doi-10.1016/j.revpalbo.2021.104483-yellow.svg)](https://doi.org/10.1016/j.revpalbo.2021.104483)
...
```{r plot_data, echo=TRUE, fig.alt="Map showing the four European example sequences included in RRatepol::example_data."}
example_data %>%
  ggplot2::ggplot(
    ggplot2::aes(
      x = long,
...
```{r plot_1, echo=TRUE, fig.alt="Rate of change score through time for the first example sequence using age-weighted smoothing and chi-squared dissimilarity."}
RRatepol::plot_roc(
...
```{r plot_2, echo=TRUE, fig.alt="Rate of change score through time for the first example sequence with standardisation and age uncertainty, including uncertainty envelopes."}
RRatepol::plot_roc(
...
```{r plot_3, echo=TRUE, fig.alt="Rate of change score through time for the first example sequence using binning with a moving window."}
RRatepol::plot_roc(
...
```{r plot_4, echo=TRUE, fig.alt="Rate of change score through time with detected peak points and a non-linear trend fitted to the first example sequence."}
