...
What is new in the package? See [NEWS](https://github.com/HOPE-UIB-BIO/R-Ratepol-package/blob/master/NEWS.md)
...
1.  Assemblage and age-model data are extracted from the original source and is compiled together, i.e. depth, age, taxon 1, taxon 2, etc.
...
For more detailed example, see [Materials for Seminar Day of PalaeoSIG: Data Manipulation & Statistical Analysis in Palaeoecology](https://github.com/OndrejMottl/palaeoR_R-Ratepol_workshop) 
