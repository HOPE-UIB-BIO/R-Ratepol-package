...
R-Ratepol currently provides several options for selecting WU, namely as individual levels (`Working_Units = "levels"`), selective binning of levels (`Working_Units = "bins"`), and our new method of binning with a moving window (`Working_Units = "MW"`), which is summarised in figure.
