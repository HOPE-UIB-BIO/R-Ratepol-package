...
```{r download of data, results='hide', warning=FALSE, message=FALSE}
...
```{r count preparation, results='hide', warning=FALSE}
gl_counts <- 
...
```{r count diplay, echo=FALSE, results='asis', warning=FALSE, message=FALSE}
...
```{r level preparion, results='hide', warning=FALSE}
gl_level <-
...
```{r level diplay, echo=FALSE, results='asis', warning=FALSE, message=FALSE}
...
```{r chron.control prepare, results='hide', warning=FALSE}
...
```{r chron.control show, echo=FALSE, results='asis', warning=FALSE, message=FALSE}
pander::pandoc.table(gl_chron_control_table)
```

```{r Bchron real, echo=FALSE, results='hide', warning=FALSE, message=FALSE}
# this is to speed up the process of loading the the vignette
try(
  load(here::here("data/gl_bchron.rda")))
...
```{r Bchron figure, results='markup', warning=FALSE}
plot(gl_bchron)
```

Predict ages

```{r Predic ages, results='hide', warning=FALSE}
age_position <- 
...
```{r level predicted diplay, echo=FALSE, results='asis', warning=FALSE, message=FALSE}
...
```
```{r RoC real, echo=FALSE, results ='hide', warning=FALSE, message=FALSE}
# this is to speed up the process of loading the the vignette
try(
  load(here::here("data/gl_roc.rda")))
...
```{r Peak points, results='hide', warning=FALSE}
gl_roc_peaks <-
...
```{r Figure, results='markup', echo=TRUE}
